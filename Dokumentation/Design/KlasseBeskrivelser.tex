...
\para{void}
\retu{static void}
\comm{Denn funktion udskriver det valgte program igennem COM-porten.}
\end{Function}
...
\para{void}
\retu{static void}
\comm{Denne funktion udskriver gennemsnitsværdien for de sidste målinger af sonarsensorerne igennem COM-porten og om dronen flyver i fri højde eller i en fixeret højde.}
\end{Function}
...
\para{void}
\retu{static void}
\comm{Denne funktion udskriver igennem COM-porten receiver-input i form af x-, y- og z-aksen, gaspedalen og om den skal holde en bestemt højde.}
\end{Function}
...
\retu{void}
\comm{Udskriver igennem COM-porten en besked eller et tal i den givende kategori og bliver på den nuværende linje.}
\end{Function}
...
\retu{void}
\comm{Udskriver igennem COM-porten en besked eller et tal i den givende kategori og skifter derefter til en ny linje.}
\end{Function}
