...
\para{void}
\retu{void}
\comm{Denne funktion udskriver forskellige debug-informationer 2 gange i sekundet, herunder sonarsensorernes målinger, om disse er advarsler, det valgte program og styringsinput.}
\end{Function}
...
\para{void}
\retu{static void}
\comm{Udskriver hvilken sonar der er advarsel fra, såfremt der er en.}
\end{Function}
...
\para{void}
\retu{bool}
\comm{Udskriver motorernes nuværende status -- slukket eller ej.}
\end{Function}
