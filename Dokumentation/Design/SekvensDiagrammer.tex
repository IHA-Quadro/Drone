...
\begin{figure}[H]
\centering
\includegraphics[angle=90, scale = 0.43]{SekvensInit}
...
\begin{figure}[htbp]
\centering
\includegraphics[width = \textwidth]{DroneLoop}
...
Såfremt de registrerer noget (på et gennemsnit af de seneste to målinger), vil et flag blive sat, hvilket checkes for i \code{DecideProgram()} (fra Figur \ref{Fig:50Hz}), hvorefter dronen vil reagere på alle kombinationer der er af disse input (se Tabel \ref{Tab:SonarAdvarsel}).\fxnote{Mere tekst her.}
...
\caption{PID'ens effekt på de fire motorer vist med forskellige farver, samt det de skal ramme.\fxnote{Dette skal forklares bedre}}
