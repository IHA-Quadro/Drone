...
\begin{TestCaseIntro}
\TCprep{Placer dronen på en vandret flade. Lad dronen være koblet til en strømforsyning med varierbar\fxnote{Stavet rigtigt?} spænding. }
...
\begin{TestCaseIntro}
\TCprep{Dronens svæver i luften efter Use Case 2, normalforløb 1 er kørt.}
\TCdesc{Én af dronens propeller spinner for\fxnote{Fy-bab?} hurtigt.}
\end{TestCaseIntro}
